...
void Star::drawStar()
{
	//glEnable启用各种功能，与glDisable相对应
	glEnable(GL_LINE_SMOOTH);	//过滤线段的锯齿
	...
	glPushMatrix();
	{
		...
		glutSolidSphere(radius, 40, 32);	//渲染一个球体，默认位置屏幕中心
	}
	//恢复绘制前的矩阵环境
	glPopMatrix();
}
